...
# trying again with purrr::map
moran.stats <- purrr::map_dfr(cran.df[3:36], .f = all.moran)
...
# I am not familiar with it. From a quick search it might be fixed by this,
# but I would check into this
# source: https://community.rstudio.com/t/error-in-nb2listw-w-nb-style-w-empty-neighbour-sets-found/96922
...
# seems to work, but I would look into it :)
